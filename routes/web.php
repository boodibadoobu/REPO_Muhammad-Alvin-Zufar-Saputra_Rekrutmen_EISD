...
Route::get('/laporan-publik', [PublicReportController::class, 'index'])->name('public-reports.index');
Route::get('/laporan-publik/{report}', [PublicReportController::class, 'show'])->name('public-reports.show');
